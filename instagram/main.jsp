<%@page import="instagram.TIME_MAXIMUM"%>
...
// String nickname = (String)session.getAttribute("nickKey");
if(email==null) //로그인이 안된 상태
	response.sendRedirect("login.jsp");

		Vector<IMemberbean> mvlist = imgr.listIMember(email);
		Vector<IBlogBean> pvlist = imgr.listI(email);
...
// 		document.frm.action = "commentcount";
// 		document.frm.num.value=num;
// 		document.frm.submit();
